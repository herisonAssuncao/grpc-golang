...
type CategoryServiceClient interface {
	...
	GetCategory(ctx context.Context, in *CategoryGetRequet, opts ...grpc.CallOption) (*Category, error)
}
...
func (c *categoryServiceClient) GetCategory(ctx context.Context, in *CategoryGetRequet, opts ...grpc.CallOption) (*Category, error) {
	out := new(Category)
...
type CategoryServiceServer interface {
	...
	GetCategory(context.Context, *CategoryGetRequet) (*Category, error)
...
func (UnimplementedCategoryServiceServer) GetCategory(context.Context, *CategoryGetRequet) (*Category, error) {
...
func _CategoryService_GetCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).GetCategory(ctx, req.(*CategoryGetRequet))
	}
	return interceptor(ctx, in, info, handler)
}
