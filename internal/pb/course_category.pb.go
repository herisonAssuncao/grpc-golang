...
func (x *CategoryGetRequet) Reset() {
	*x = CategoryGetRequet{}
	if protoimpl.UnsafeEnabled {
...
func (x *CategoryGetRequet) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CategoryGetRequet) ProtoMessage() {}

func (x *CategoryGetRequet) ProtoReflect() protoreflect.Message {
	mi := &file_proto_course_category_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CategoryGetRequet.ProtoReflect.Descriptor instead.
func (*CategoryGetRequet) Descriptor() ([]byte, []int) {
	return file_proto_course_category_proto_rawDescGZIP(), []int{4}
}

func (x *CategoryGetRequet) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_proto_course_category_proto_rawDesc = []byte{
	...
	0x65, 0x67, 0x6f, 0x72, 0x79, 0x47, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x74, 0x12, 0x0e,
	...
	0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x00, 0x12, 0x34, 0x0a,
	0x0b, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x12, 0x15, 0x2e, 0x70,
	0x62, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x47, 0x65, 0x74, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x74, 0x1a, 0x0c, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72,
...
var file_proto_course_category_proto_goTypes = []interface{}{
	...
	(*CategoryGetRequet)(nil),     // 4: pb.CategoryGetRequet
}
var file_proto_course_category_proto_depIdxs = []int32{
	...
	4, // 5: pb.CategoryService.GetCategory:input_type -> pb.CategoryGetRequet
...
func file_proto_course_category_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_course_category_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CategoryGetRequet); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
